...
const build = async ({ outfile, format, minify = false, globalName, ...rest }) => {
  ...
  build({
    ...
    outfile: new URL("web3ErrorBoundary.esm.js", lib),
    format: "esm",
    //globalName: "Client",
  ...
  build({
    entryPoints: [new URL("src/index.ts", import.meta.url).pathname],
    outfile: new URL("web3ErrorBoundary.umd.js", lib),
    format: "umd",
    globalName: "Web3ErrorBoundary",    
  });

  build({
    entryPoints: [new URL("src/index.ts", import.meta.url).pathname],
    outfile: new URL("web3ErrorBoundary.umd.min.js", lib),
    format: "umd",
    minify: true,
    globalName: "Web3ErrorBoundary",    
  });
  ...
  build({
    entryPoints: [new URL("src/index.ts", import.meta.url).pathname],
    outfile: new URL("web3ErrorBoundary.js", lib),
    format: "cjs",
    globalName: "Web3ErrorBoundary",    
  });
  ...
  build({
    entryPoints: [new URL("src/index.ts", import.meta.url).pathname],
    outfile: new URL("web3ErrorBoundary.min.js", lib),
    format: "cjs",
    minify: true,
    globalName: "Web3ErrorBoundary",    
  });